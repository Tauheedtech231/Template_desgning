...
const GallerySection: React.FC = () => {
  ...
  const galleryImages: GalleryImage[] = [
    { 
      src: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&auto=format&fit=crop&q=80&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y2FtcHVzJTIwYnVpbGRpbmd8ZW58MHx8MHx8fDA%3D", 
      title: "Main Campus Building", 
      category: "Campus" 
    },
    { 
      src: "https://images.unsplash.com/photo-1524178234883-043d5c3f3cf4?w=800&auto=format&fit=crop&q=80&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8bGlicmFyeSUyMGludGVyaW9yfGVufDB8fDB8fHww", 
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-base text-[#334155] max-w-2xl mx-auto leading-relaxed">
            A visual journey through our campus facilities, academic spaces, and student life
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {filteredImages.map((image, index) => (
            <div
              key={index}
              className="gallery-item group relative overflow-hidden rounded-lg cursor-pointer border border-gray-200 hover:shadow-lg transition-all duration-300"
            ...
            >
              ...
              <div className="relative aspect-square">
                ...
                {/* Overlay on Hover - Using theme overlay color */}
                <div 
                  className="absolute inset-0 bg-gradient-to-t from-[rgba(6,78,59,0.7)] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  style={{ backgroundColor: 'rgba(6, 78, 59, 0.7)' }}
                >
                  {/* Expand Icon */}
      ...
      {modalOpen && filteredImages.length > 0 && (
        <div
          ...
          onClick={closeModal}
        >
          {/* Navigation Buttons - Using theme color */}
          <button
            onClick={(e) => { e.stopPropagation(); prevImage(); }}
            className="absolute left-4 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full bg-[#064E3B] hover:bg-[#064E3B]/90 transition-all duration-300"
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full bg-[#064E3B] hover:bg-[#064E3B]/90 transition-all duration-300"
