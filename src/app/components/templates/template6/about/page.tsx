...
import { 
  ...
  FaSeedling, FaCompass, FaMountain, FaUsersCog,
      ...
      <div className="relative pt-20 pb-16">
        <div className="max-w-4xl mx-auto px-5 sm:px-6 lg:px-8">
          <div ref={introTextRef} className="text-center">
            ...
            {/* Main heading with Merriweather font */}
            <h1 className="text-[30px] md:text-[34px] font-serif font-medium leading-[1.3] text-[#1E1E1E] mb-6">
              Our purpose & <span className="text-[#2F5D62]">perspective</span>
            </h1>
            
            {/* Tagline - human, conversational */}
            <div className="mb-10">
              <div className="inline-block px-4 py-2 bg-[#FAFAFA] border border-[#EDEDED] rounded-sm text-[15px] text-[#4A4A4A] mb-6">
                {tagline}
              </div>
              <p className="text-[17px] md:text-[18px] text-[#4A4A4A] leading-[1.75] max-w-2xl mx-auto">
                For more than a decade, <span className="text-[#2F5D62]">we have quietly cultivated</span> an environment where education transcends routine learning—where students discover not just knowledge, but purpose.
              </p>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-[#F0F0F0]">
              <div className="text-[13px] text-[#8A8A8A]">
                Cultivating learning since <span className="text-[#2F5D62]">{establishedYear}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div className="text-center max-w-2xl px-6">
            <div className="mb-6">
              ...
              <h3 className="text-[30px] md:text-[34px] font-serif font-medium text-white mb-4 leading-[1.3]">
                Learning as a <span className="text-[#2F5D62]">human</span> experience
              </h3>
              <p className="text-[17px] text-white/85 max-w-lg mx-auto leading-[1.75]">
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-6 lg:px-8 py-20">
          <div ref={storyRef} className="mb-24">
            <div className="mb-12">
              ...
              <h2 className="text-[30px] md:text-[34px] font-serif font-medium text-[#1E1E1E] mb-8 leading-[1.3]">
                How we arrived here, <span className="text-[#2F5D62]">and why it matters</span>
              </h2>
            </div>
              ...
              {story.map((paragraph, index) => (
                <div key={index} className="story-paragraph">
                  <div className="flex">
                    ...
                    <p className="text-[17px] md:text-[18px] text-[#4A4A4A] leading-[1.75] flex-1">
                      {paragraph}
                    </p>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-sm bg-[#FAFAFA] border border-[#EDEDED] flex items-center justify-center">
                  <FaBullseye className="text-[#2F5D62] text-lg" />
                </div>
                <h3 className="text-[22px] font-serif font-medium text-[#1E1E1E]">
                  Our <span className="text-[#2F5D62]">intention</span>
                </h3>
              </div>
              
              <div className="pl-14">
                <p className="text-[17px] text-[#4A4A4A] leading-[1.75]">
                  {mission}
                </p>
              </div>
                ...
                <div className="space-y-2">
                  {["Academic depth", "Practical relevance", "Personal growth", "Community contribution"].map((item, index) => (
                    <div key={index} className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 bg-[#2F5D62] rounded-full"></div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-sm bg-[#2F5D62] flex items-center justify-center">
                  <FaRocket className="text-white text-lg" />
                </div>
                <h3 className="text-[22px] font-serif font-medium text-[#1E1E1E]">
                  Looking <span className="text-[#2F5D62]">ahead</span>
                </h3>
              </div>
          ...
          <div ref={philosophyRef} className="mb-24">
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="text-[30px] md:text-[34px] font-serif font-medium text-[#1E1E1E] mb-6 leading-[1.3]">
                  {philosophy.heading}
                </h2>
              </div>
              ...
              <div className="space-y-6">
                {philosophy.points.map((point, index) => (
                  <div key={index} className="flex items-start gap-4 p-4 bg-[#FAFAFA] border border-[#EDEDED] rounded-sm">
                    ...
                    <p className="text-[17px] text-[#4A4A4A] leading-[1.75] flex-1">
                      {point}
                    </p>
                  </div>
                ))}
          ...
          <div ref={whyChooseUsRef} className="mb-24">
            <div className="text-center mb-12">
              ...
              <h2 className="text-[30px] md:text-[34px] font-serif font-medium text-[#1E1E1E] mb-6 leading-[1.3]">
                Why <span className="text-[#2F5D62]">choose us</span>
              </h2>
              <p className="text-[17px] text-[#4A4A4A] max-w-2xl mx-auto leading-[1.75] italic">
                {whyChooseUs.intro}
              </p>
            </div>
            ...
            <div ref={whyChooseCardsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {whyChooseUs.points.map((point, index) => {
                ...
                return (
                  <div 
                    key={index}
                    className="why-choose-card group bg-white border border-[#EDEDED] rounded-sm p-6 hover:border-[#2F5D62]/30 transition-all duration-300"
                  >
                    <div className="flex flex-col h-full">
                      {/* Icon with subtle background */}
                      <div className="mb-5">
                        <div className="w-12 h-12 rounded-sm bg-[#FAFAFA] border border-[#EDEDED] flex items-center justify-center group-hover:border-[#2F5D62]/30 transition-colors duration-300">
                          <Icon className="text-[#2F5D62] text-lg" />
                        </div>
                      </div>
                      ...
                      {/* Description */}
                      <p className="text-[16px] text-[#4A4A4A] leading-[1.75] flex-grow mb-4">
                        {point.description}
                      </p>
                      ...
                      <div className="mt-auto pt-4 border-t border-[#F0F0F0]">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="w-6 h-6 rounded-full border border-[#EDEDED] flex items-center justify-center">
                            <div className="w-2 h-2 rounded-full bg-[#2F5D62]"></div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div ref={valuesRef} className="mb-24">
            <div className="text-center mb-12">
              ...
              <h2 className="text-[30px] md:text-[34px] font-serif font-medium text-[#1E1E1E] mb-6 leading-[1.3]">
                The principles that guide <span className="text-[#2F5D62]">our choices</span>
              </h2>
              <p className="text-[17px] text-[#4A4A4A] max-w-xl mx-auto leading-[1.75]">
                    ...
                    <div className="flex flex-col md:flex-row md:items-start gap-6 p-6 bg-white border border-[#F0F0F0] rounded-sm hover:border-[#E0E0E0] transition-colors duration-300">
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 rounded-sm bg-[#FAFAFA] border border-[#EDEDED] flex items-center justify-center">
                          <Icon className="text-[#2F5D62] text-xl" />
                        </div>
                      </div>
                      ...
                      <div className="flex-shrink-0">
                        <div className="text-[13px] text-[#2F5D62] font-medium">
                          0{value.id}
                        </div>
                      </div>
                    </div>
                  ...
                  <div key={index} className="flex flex-col md:flex-row gap-6 pb-8 border-b border-[#F0F0F0] last:border-0 last:pb-0">
                    <div className="flex-shrink-0 md:w-40">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-px bg-[#2F5D62]"></div>
        ...
        <div className="py-16 border-t border-[#F0F0F0] bg-[#FAFAFA]">
          <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <FaShieldAlt className="text-[#2F5D62]" />
              <div className="w-6 h-px bg-[#E0E0E0]"></div>
            </div>
            <p className="text-[16px] text-[#4A4A4A] leading-[1.75]">
              Accredited by the National Education Board • Committed to <span className="text-[#2F5D62]">educational excellence</span> since {establishedYear}
            </p>
          </div>
        </div>
      </div>
