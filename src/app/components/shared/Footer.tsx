      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 text-sm mb-4 leading-relaxed">
              Empowering students through quality education and innovative research since 1990.
            </p>
            <div className="flex space-x-2">
              <a 
                href={defaultCollegeInfo.contact.socialMedia.facebook} 
              ...
              <a 
                href={defaultCollegeInfo.contact.socialMedia.twitter} 
              ...
              <a 
                href={defaultCollegeInfo.contact.socialMedia.instagram} 
              ...
              <a 
                href={defaultCollegeInfo.contact.socialMedia.linkedin} 
        ...
        <div className="border-t border-gray-700 mt-6 pt-6 text-center">
          <p className="text-gray-300 text-xs">
            &copy; {currentYear} <span className="text-white font-semibold">Kips College</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
